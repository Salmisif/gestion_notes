<%-- Document : article Created on : 17 déc. 2022, 11:07:36 Author : HP --%>
...
contentType="text/html" pageEncoding="UTF-8"%>
                ...
                <body>
                    ...
                    <sql:query dataSource="${ds}" var="r"> select * from article; </sql:query>
                        ...
                        <form class="tab" style="margin-top: 50px">
                            ...
                            <table class="table table-dark table-hover">
                                <tr>
                                    ...
                                    <td style="color: white">Nom_Article</td>
                                ...
                                <c:forEach var="id" items="${r.rows}">
                                    <tr>
                                        ...
                                        <td style="color: white">
                                            <c:out value="${id.Quantity}" />
                                        </td>
                                        <td style="color: white">
                                            <c:out value="${id.PrixVent}" /> $</td>
                                        <td>
                                            <c:url var="lien" value="deletArticle.jsp">
                                                <c:param name="RA" value="${id.RA}" />
                                            </c:url>
